  ...
  return (
    isMobile ? (
      <>
        ...
        <Dialog open={showFilter} onClose={handleFilterClick} fullWidth maxWidth="xs"
          sx={{
            '& .MuiDialog-paper': {
              maxHeight: 400,
              overflowY: 'auto',
        ...
        >
          ...
          <DialogActions>
            <Button onClick={handleFilterClick} color="secondary">Cancel</Button>
            <Button onClick={() => { handleSearch(); handleFilterClick(); }} variant="contained" color="primary">Search</Button>
          </DialogActions>
        </Dialog>
      </>
    ) : (
