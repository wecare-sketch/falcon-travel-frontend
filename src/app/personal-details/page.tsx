...
import PersonalDetailsForm from "@/components/personal-details/PersonalDetailsForm";
    ...
    >
      ...
      <div className="flex flex-1 flex-col lg:flex-row items-center justify-center min-h-screen w-full">
        ...
        <Box className="hidden lg:flex flex-1 flex-col justify-end items-start mt-[500px] ml-10">
          <div className="font-inter font-medium text-[2.5rem] leading-[100%] tracking-normal text-white drop-shadow-lg">
            Drive Prestige, Arrive in Style
          </div>
          <div className="font-inter font-medium text-[4.25rem] leading-[100%] tracking-normal text-white drop-shadow-lg">
